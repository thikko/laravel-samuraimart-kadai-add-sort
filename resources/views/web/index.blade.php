                            ...
                            <div class="row">
                                <div class="col-12">
                                    <p class="samuraimart-product-label mt-2">
                                        ...
                                        <br>
                                        <div class="average-score-1">
                                            <div class="average-score-2">
                                            ...
                                            <div>{{ round($recommend_product->reviews()->avg('score'), 1) }}</div>
                                        </div>
                                        <br>
                                    ...
                                    <p class="samuraimart-product-label mt-2">
                                        ...
                                        <div class="average-score-1">
                                            <div class="average-score-2">
                                                ...
                                                <div class="samuraimart-star-rating" data-rate="{{ round($recently_product->reviews->avg('score') * 2) / 2 }}"></div>
                                                @endif
                                            </div>
                                            <div>{{ round($recently_product->reviews()->avg('score'), 1) }}</div>
                                        </div>
                                        <br>
